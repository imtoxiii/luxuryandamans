  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <motion.button
        ...
        className={`relative p-4 rounded-full shadow-2xl ${isExpanded ? 'bg-gradient-to-br from-red-500 to-pink-600' : 'bg-blue-600'
          } text-white hover:shadow-3xl transition-all duration-300`}
        onClick={() => {
          const newState = !isExpanded;
          setIsExpanded(newState);
          window.dispatchEvent(new CustomEvent('chatWidgetState', { detail: { isOpen: newState } }));
        }}
