...
const quickLinks = [
  ...
  { name: 'Honeymoon Packages', href: '/blog/andaman-honeymoon-packages-2026' },
  { name: 'Packages from Delhi', href: '/blog/andaman-packages-from-delhi-2026' },
  { name: '4N/5D Andaman Package', href: '/blog/4-nights-5-days-andaman-package-2026' },
