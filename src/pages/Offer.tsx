    ...
    return (
        <div className="min-h-screen font-sans bg-slate-50 selection:bg-purple-100 selection:text-purple-900 overflow-x-hidden">
            ...
            <div className="relative h-screen flex items-center justify-center overflow-hidden bg-slate-900">
                ...
                >
                    {/* Reduced overlay opacity to let the image shine */}
                    <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-slate-900/90 z-10" />
                    <img
                ...
                <div className="relative z-20 container mx-auto px-4 text-center text-white mt-20">
                    ...
                    >
                        ...
                        <motion.h1 variants={itemVariants} className="text-6xl md:text-8xl lg:text-9xl font-display font-bold mb-8 leading-[1.1] tracking-tight drop-shadow-lg">
                            Paradise <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600">Awaits</span>
                        </motion.h1>
                        ...
                        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full max-w-lg mx-auto">
                            <button
                                ...
                                className="group w-full sm:w-auto px-10 py-5 bg-purple-600 text-white rounded-2xl font-bold text-lg hover:bg-purple-700 transition-all flex items-center justify-center gap-3 shadow-[0_10px_40px_rgba(147,51,234,0.4)] hover:shadow-[0_15px_50px_rgba(147,51,234,0.6)] transform hover:-translate-y-1"
                            >
                        ...
                        <motion.div variants={itemVariants} className="mt-16 flex flex-wrap items-center justify-center gap-8 md:gap-16 text-sm md:text-base text-white/80 font-medium tracking-wide">
                            <div className="flex items-center gap-3">
                                <div className="p-1 rounded-full bg-purple-500/30 backdrop-blur-sm"><CheckCircle2 className="w-4 h-4 text-purple-300" /></div>
            ...
            <div className="bg-white border-b border-slate-100 py-12 overflow-hidden relative z-20">
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap justify-center gap-12 md:gap-24 opacity-80">
                        <div className="flex items-center gap-3 font-display font-bold text-xl text-slate-800"><Shield className="w-6 h-6 text-purple-600" /> SafeTravels</div>
                        <div className="flex items-center gap-3 font-display font-bold text-xl text-slate-800"><Star className="w-6 h-6 text-purple-600" /> 4.9/5 Reviews</div>
                        <div className="flex items-center gap-3 font-display font-bold text-xl text-slate-800"><Users className="w-6 h-6 text-purple-600" /> 10k+ Happy Guests</div>
                    </div>
                </div>
            </div>
            ...
            <section className="py-32 bg-slate-50 relative">
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        <span className="text-purple-600 font-bold tracking-[0.2em] uppercase text-sm mb-4 block">Best Sellers</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {featuredPackages.map((pkg, index) => (
                            <motion.div
                                ...
                                className="group bg-white rounded-[2.5rem] overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-500 border border-slate-100 flex flex-col h-full hover:-translate-y-2"
                            >
                                ...
                                <div className="p-8 flex flex-col flex-grow relative">
                                    <div className="absolute -top-6 right-8 w-14 h-14 bg-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/30 group-hover:scale-110 transition-transform duration-300 rotate-3 group-hover:rotate-6">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="pt-6 border-t border-slate-100 flex items-end justify-between">
                                            ...
                                            <Link
                                                ...
                                                className="px-8 py-3 bg-slate-900 text-white rounded-2xl font-bold text-sm hover:bg-purple-600 transition-colors shadow-lg hover:shadow-purple-500/30"
                                            >
                                                View Plan
                                            </Link>
                                        </div>
                    ...
                    <div className="mt-20 text-center">
                        <Link to="/packages" className="inline-flex items-center gap-3 text-slate-900 font-bold text-lg hover:text-purple-600 transition-colors group">
                            <span className="border-b-2 border-slate-900 group-hover:border-purple-600 pb-1 transition-colors">View All Packages</span>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <motion.div 
                            ...
                            className="relative"
                        >
                            <div className="absolute -inset-10 bg-purple-50/50 rounded-full blur-3xl opacity-50" />
                            <img
                            ...
                            >
                                <div className="flex items-center gap-6">
                                    <div className="w-16 h-16 bg-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/20 text-white">
                        ...
                        <motion.div
                            ...
                            transition={{ duration: 0.8 }}
                        >
                            <span className="text-purple-600 font-bold tracking-[0.2em] uppercase text-sm">Why Choose Luxury Andamans</span>
                            <h2 className="text-5xl md:text-6xl font-display font-bold text-slate-900 mt-4 mb-10 leading-tight">We Don't Just Plan Trips, We Craft <span className="text-purple-600 italic">Memories</span></h2>
                            ...
                            <div className="space-y-10">
                                {[
                                    ...
                                    >
                                        <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:bg-purple-600 transition-all duration-300 shadow-sm group-hover:shadow-lg group-hover:shadow-purple-500/30">
                                            <item.icon className="w-8 h-8 text-purple-600 group-hover:text-white transition-colors duration-300" />
                                        </div>
                                        <div>
            ...
            <section id="quick-enquiry" className="py-32 bg-slate-900 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        <div className="md:w-2/5 bg-purple-700 p-12 text-white flex flex-col justify-between relative overflow-hidden">
                            <div className="relative z-10">
                                <h3 className="text-4xl font-display font-bold mb-6">Plan Your Dream Trip</h3>
                                <p className="text-purple-100 mb-10 text-lg leading-relaxed">Fill the form and get a callback within 10 minutes from our travel experts.</p>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all text-lg"
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                onChange={handleChange}
                                                className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all text-lg appearance-none"
                                            >
                                ...
                                <button
                                    ...
                                    className="w-full py-5 bg-slate-900 text-white rounded-2xl font-bold text-xl hover:bg-purple-700 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                                >
